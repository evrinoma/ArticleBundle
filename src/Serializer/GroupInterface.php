...
interface GroupInterface
{
    ...
    public const API_POST_ARTICLE_CLASSIFIER = 'API_POST_ARTICLE_CLASSIFIER';
    public const API_PUT_ARTICLE_CLASSIFIER = 'API_PUT_ARTICLE_CLASSIFIER';
    public const API_GET_ARTICLE_CLASSIFIER = 'API_GET_ARTICLE_CLASSIFIER';
    public const API_CRITERIA_ARTICLE_CLASSIFIER = self::API_GET_ARTICLE_CLASSIFIER;
    public const APP_GET_BASIC_ARTICLE_CLASSIFIER = 'APP_GET_BASIC_ARTICLE_CLASSIFIER';
}
