 ...
 * @group functional
 */
final class ClassifierApiControllerTest extends AbstractFunctionalTest
{
    protected string $actionServiceName = 'evrinoma.article.test.functional.action.classifier';
