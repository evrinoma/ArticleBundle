...
use Evrinoma\ArticleBundle\Factory\ArticleFactoryInterface;
use Evrinoma\ArticleBundle\Mediator\CommandMediatorInterface;
...
final class CommandManager implements CommandManagerInterface
{
     ...
     * @param ArticleFactoryInterface    $factory
     * @param CommandMediatorInterface   $mediator
     */
    public function __construct(ValidatorInterface $validator, ArticleRepositoryInterface $repository, ArticleFactoryInterface $factory, CommandMediatorInterface $mediator)
    {
