...
namespace Evrinoma\ArticleBundle\Facade\Type;

use Evrinoma\ArticleBundle\Manager\Type\CommandManagerInterface;
use Evrinoma\ArticleBundle\Manager\Type\QueryManagerInterface;
use Evrinoma\ArticleBundle\PreValidator\Type\DtoPreValidatorInterface;
